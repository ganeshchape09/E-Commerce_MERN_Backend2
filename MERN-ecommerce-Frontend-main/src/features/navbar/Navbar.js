      ...
      {userInfo && (
        <div className="min-h-full">
                    ...
                    <div className="hidden md:block">
                      <div className="ml-4 flex items-center md:ml-6">
                        <Link to="/cart">
                          <button
                            type="button"
                            className="rounded-full bg-blue-400 p-1 text-white hover:text-blue-400 hover:hover:bg-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                          >
          ...
          <header className="bg-gray-200 shadow">
            <div
              className="text-center px-8 p-5 "
